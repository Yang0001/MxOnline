...
class CourseOrg(models.Model):
    ...
    city = models.ForeignKey(CityDict, null=True, on_delete=models.CASCADE, verbose_name=u"所在城市")
...
class Teacher(models.Model):
    ...
    image = models.ImageField(default='', upload_to="teacher/%Y/%m", verbose_name=u"logo")
    add_time = models.DateTimeField(default=datetime.now)
